...
class Hello(object):
    ...
    學號:<input type=text name=N><br />
    姓名:<input type=text name=M><br />
    ...
    '''
        ...
        return outstring
    #@+node:2015.20150428102909.1803: *3* index1
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    def index1(self,N=15,M=15):
        outstring = '''
    <!DOCTYPE html> 
    <html>
    <head>
    ...
    #@+node:2015.20150428110953.1750: *3* spuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
    ...
    #@+node:2015.20150428110953.1748: *3* drawspuraction
    @cherrypy.expose
    # N 為齒數, M 為模數, P 為壓力角
